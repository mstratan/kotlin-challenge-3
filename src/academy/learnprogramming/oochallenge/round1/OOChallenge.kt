package academy.learnprogramming.oochallenge.round1

fun main() {
    val bike = Bicycle(5, 10, 1)
    bike.printDescription()

    val mountainBike = MountainBike(22,6, 11, 2)
    mountainBike.printDescription()

    val roadBike = RoadBike(55, 4, 20, 3)
...
class MountainBike(var seatHeight: Int, cadence: Int, speed: Int, gear: Int): Bicycle(cadence, speed, gear) {
